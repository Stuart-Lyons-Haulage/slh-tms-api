    ...
    IReadOnlyList<MasterField> Fields)
{
    public static IReadOnlyDictionary<string, MasterListDefinition> All { get; } =
        new Dictionary<string, MasterListDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["customercontact"] = new("customercontact", "Hub Customer Contacts", "master_customer_contacts", "ContactId",
                FieldSet("ContactId", "CustomerId", "ContactName", "Email", "MobileNumber", "ReceivesEtaUpdates", "IsActive")),
            ["driver"] = new("driver", "Hub Drivers", "master_drivers", "DriverId",
                FieldSet("DriverId", "EmployeeNumber", "FullName", "PreferredName", "DisplayName", "TachoName", "MobileNumber", "Email", "SourceSite", "StartedOn", "CardLastRead", "LicenceNumber", "LicencePassDate", "LicenceExpiry", "LicenceCheckDue", "LicencePhotoExpiry", "CPCExpiry", "DqcExpiry", "DigitalTachoCardExpiry", "MedicalExpiry", "TachoCardNumber", "TachoMasterDriverId", "EmploymentType", "AgencyName", "DriverType", "DriverGroup", "Skills", "Coding", "Notes", "DefaultDepotId", "IsActive")),
            ["vehicle"] = new("vehicle", "Hub Vehicles", "master_vehicles", "VehicleId",
                FieldSet("VehicleId", "FleetNumber", "Registration", "VIN", "VehicleSite", "OwnerType", "VehicleType", "Abbreviation", "Transmission", "DvsCompliant", "FuelProvider", "CabMobile", "FuelPin", "ShellCard", "BpRedCard", "BpPlainCard", "FuelPinSecretName", "FuelCardLastFour", "FleetioAssetId", "FleetioName", "FleetioStatus", "SamsaraAssetId", "MOTExpiry", "TachoCalibrationExpiry", "VehicleTestExpiry", "Notes", "DefaultDepotId", "IsActive")),
    ...
    {
        "DriverId" => ["Member Code", "MemberCode", "Member_x0020_Code", "DriverId", "DriverKey", "EmployeeNumber", "Employee Number", "Employee_x0020_Number"],
        "EmployeeNumber" => ["EmployeeNumber", "Employee Number", "Employee_x0020_Number"],
        "MobileNumber" => ["MobileNumber", "Mobile", "DriverMobile"],
        "FullName" => ["FullName", "Worker Name", "DriverName", "Driver", "Title"],
        "TachoMasterDriverId" => ["TachoMasterDriverId", "Member Code", "MemberCode", "Member_x0020_Code"],
        "Email" => ["Email", "DriverEmail"],
        "SourceSite" => ["Site", "WorkerSite"],
        "StartedOn" => ["Started", "StartedOn"],
        "EmploymentType" => ["Type", "WorkerType", "EmploymentType"],
        "AgencyName" => ["Agency", "AgencyName"],
        "TachoCardNumber" => ["Driver Card No.", "DriverCardNo", "Driver_x0020_Card_x0020_No.", "TachoCardNumber", "Tacho Card", "Tacho_x0020_Card"],
        "CardLastRead" => ["Card Last Read", "CardLastRead", "Card_x0020_Last_x0020_Read"],
        "LicenceExpiry" => ["Driving Licence Exp.", "LicenceExpiry"],
        "LicencePassDate" => ["Licence Pass Date", "LicencePassDate"],
        "LicenceCheckDue" => ["Licence Check Due", "LicenceCheckDue"],
        "LicencePhotoExpiry" => ["Licence Photo Exp.", "LicencePhotoExpiry"],
        "CPCExpiry" => ["CPC Expiry", "CPCExpiry"],
        "DigitalTachoCardExpiry" => ["Driver Card Exp.", "DigitalTachoCardExpiry"],
        "DqcExpiry" => ["DQC Expiry", "DqcExpiry"],
        "CustomerId" => ["CustomerId", "CustomerKey", "AccountCode", "CustomerCode"],
        "CustomerName" => ["CustomerName", "TradingName", "Title"],
        "ContactId" => ["ContactId", "ContactKey"],
        "ContactName" => ["ContactName", "Name", "Title"],
        "VehicleId" => ["VehicleId", "VehicleKey", "Title"],
        "VIN" => ["VIN", "Vin"],
        "VehicleSite" => ["Site", "VehicleSite"],
        "OwnerType" => ["Owner Type", "OwnerType", "Owner_x0020_Type"],
        ...
        "Name" => ["Seller", "Name", "Market Name / Seller"],
        "StandOrLocation" => ["Stall/Stand", "StallStand", "Stall_x002f_Stand", "StandOrLocation"],
