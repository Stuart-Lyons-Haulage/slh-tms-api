    ...
    public static IReadOnlyDictionary<string, MasterListDefinition> All { get; } =
        new Dictionary<string, MasterListDefinition>(StringComparer.OrdinalIgnoreCase)
        {
            ["depot"] = new("depot", "Depots", "master_depots", "DepotId",
                Fields("DepotId", "DepotName", "Address", "Postcode", "Latitude", "Longitude", "GeofenceRadiusMetres")),
            ["customer"] = new("customer", "Hub Customers", "master_customers", "CustomerId",
                Fields("CustomerId", "CustomerName", "AccountCode", "TradingName", "CustomerAliases", "InvoiceAddress", "InvoiceEmail", "DefaultContactName", "DefaultContactPhone", "AccountOwner", "ServiceNotes", "DefaultSiteCode")),
            ["driver"] = new("driver", "Hub Drivers", "master_drivers", "DriverId",
                Fields("DriverId", "FullName", "PreferredName", "DisplayName", "TachoName", "MobileNumber", "LicenceNumber", "LicenceExpiry", "CPCExpiry", "DigitalTachoCardExpiry", "MedicalExpiry", "TachoCardNumber", "TachoMasterDriverId", "EmploymentType", "AgencyName", "DriverType", "DriverGroup", "Skills", "Coding", "Notes", "DefaultDepotId")),
            ...
            ["site"] = new("site", "Hub Sites", "master_sites", "SiteId",
                Fields("SiteId", "SiteName", "CustomerId", "CustomerCode", "Address", "Address2", "Postcode", "Latitude", "Longitude", "GeofenceRadiusMetres", "SiteType", "OpenTime", "CloseTime", "SpecialInstructions", "DriverTextName", "CollectionInstructions", "MapLink", "OperationalRegion")),
            ["subcontractor"] = new("subcontractor", "Subcontractors", "master_subcontractors", "SubcontractorId",
                Fields("SubcontractorId", "CompanyName", "ContactName", "ContactPhone", "ContactEmail", "OperatorLicenceNumber", "OperatorLicenceExpiry", "InsuranceExpiry")),
            ["market"] = new("market", "TMS Markets", "master_markets", "MarketId",
                Fields("MarketId", "Market", "Name", "StandOrLocation", "Salesman", "Sender")),
            ["fuelcard"] = new("fuelcard", "Fuel Cards", "master_fuel_cards", "FuelCardId",
                Fields("FuelCardId", "VehicleId", "Registration", "FuelProvider", "FuelPinSecretName", "FuelCardLastFour", "ShellCard", "BpRedCard", "BpPlainCard")),
            ["fuelprice"] = new("fuelprice", "Fuel Pricing", "master_fuel_prices", "FuelPriceId",
                Fields("FuelPriceId", "WeekCommencing", "Provider", "PricePencePerLitre", "IsPricingMaximum", "Source", "Notes"))
        };
